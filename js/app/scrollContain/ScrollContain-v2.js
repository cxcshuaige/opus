...
*/
	ScrollContain.prototype._readyDom = function(){
		...
		this.len = this.cellLi.size();
		this.scrollContain.width(this.len*this.cellW);

		this.cellLi.each(function(i,o){
			$(this).click(function(){
				_t._cellClick($(this),i);
			});
		});
...
*/
	ScrollContain.prototype._leftClick = function(e){
		...
		this._cellClick(dom,this.index);
	}
...
* 单元单机事件注册
*/
	ScrollContain.prototype._cellClick = function(o,i){
		if(o.hasClass('cur')) return;
		this._comCellClick(o,i);
...
* 单元单机事件注册
*/
	ScrollContain.prototype._comCellClick = function(o,i){
